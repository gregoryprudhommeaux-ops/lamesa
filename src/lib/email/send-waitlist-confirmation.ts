    ...
    locale === "en"
      ? {
          ...
          funnel: [
            ...
            "4. You confirm your seat by paying the ACCESS ticket (inclusions depend on the edition). The negotiated menu is paid on site.",
          ].join("\n"),
      ...
      : locale === "es"
        ? {
            ...
            funnel: [
              ...
              "4. Confirmas tu lugar pagando el ticket ACCESS (inclusiones según edición). El menú negociado se paga en el lugar.",
            ].join("\n"),
        ...
        : {
            ...
            funnel: [
              ...
              "4. Tu confirmes ta place en réglant le ticket ACCESS (inclus selon l’édition). Le menu négocié se paie sur place.",
            ].join("\n"),
