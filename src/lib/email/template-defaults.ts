...
const DEFAULTS: Record<SystemEmailTemplateKey, Record<TemplateLocale, LocalePair>> = {
  ...
  payment_relance: {
    es: {
      subject: "Recordatorio — pago ACCESS · {{eventTitle}}",
      body: [
        "Estimado/a {{fullName}}:",
        "",
        "Te escribimos para recordarte el pago del ticket ACCESS de LA MESA « {{eventTitle}} ».",
        "",
        "Fecha y hora: {{when}}",
        "Lugar: {{where}}",
        "",
        ...
        "Página del evento: {{eventUrl}}",
        "",
        "Cuando recibamos el pago, confirmaremos tu lugar.",
        "",
        "Quedamos a tus órdenes,",
        "LA MESA",
      ].join("\n"),
    ...
    fr: {
      ...
      body: [
        "Bonjour {{fullName}},",
        "",
        "Petit rappel pour le règlement du ticket ACCESS de LA MESA « {{eventTitle}} ».",
        "",
        "Quand : {{when}}",
        "Où : {{where}}",
        "",
        ...
        "Page de l’événement : {{eventUrl}}",
        "",
        "Dès réception du virement, on confirme ta place.",
        "",
        "À bientôt,",
        "LA MESA",
      ].join("\n"),
    ...
    en: {
      ...
      body: [
        "Hi {{fullName}},",
        "",
        "A quick reminder about the ACCESS ticket payment for LA MESA « {{eventTitle}} ».",
        "",
        "When: {{when}}",
        "Where: {{where}}",
        "",
        ...
        "Event page: {{eventUrl}}",
        "",
        "Once we receive payment, we’ll confirm your seat.",
        "",
        "See you soon,",
        "LA MESA",
      ].join("\n"),
