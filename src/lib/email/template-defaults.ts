  ...
  places_available: {
    es: {
      ...
      body: [
        ...
        "",
        "Si quieres el lugar: responde a este correo con un OUI (o pulsa YES). Si quedan lugares, te enviamos los datos de pago.",
        "YES: {{yesUrl}}",
        "NO: {{noUrl}}",
        "",
    ...
    fr: {
      ...
      body: [
        ...
        "",
        "Tu veux venir ? Réponds à cet email avec un OUI (ou clique YES). S’il reste de la place, on t’envoie les coordonnées de paiement.",
        "YES : {{yesUrl}}",
        "NO : {{noUrl}}",
        "",
    ...
    en: {
      ...
      body: [
        ...
        "",
        "Want in? Reply YES to this email (or tap YES). If a seat remains, we’ll send payment details.",
        "YES: {{yesUrl}}",
        "NO: {{noUrl}}",
        "",
