  ...
  light_signup: {
    es: {
      ...
      body: [
        ...
        "",
        "Para invitarte a las próximas cenas, completa tu perfil cuando puedas.",
        "",
    ...
    fr: {
      ...
      body: [
        ...
        "",
        "Pour t’inviter aux prochaines soirées, complète ton profil quand tu peux.",
        "",
    ...
    en: {
      ...
      body: [
        ...
        "",
        "To invite you to upcoming dinners, finish your profile when you can.",
        "",
