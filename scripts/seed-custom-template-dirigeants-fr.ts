...
const locales = {
  fr: {
    ...
    body: [
      ...
      "",
      "La soirée du **24 septembre** (à partir de 20 h) se compose selon qui répond. Fondateurs, dirigeants, entrepreneurs établis : des gens qui portent déjà une vraie responsabilité. On ne publie pas la liste des noms à l’avance ; le filtre, c’est le profil et l’intention.",
      "",
      "C’est un **Save the Date**. Tu indiques ton intérêt, on calibre le lieu au centre avec le nombre de réponses, puis on te confirme. Selon ta réponse, tu recevras une invitation formelle avec les détails, ainsi que les modalités de règlement à compléter par transfert avant la rencontre.",
      "",
  ...
  es: {
    ...
    body: [
      ...
      "",
      "La noche del **24 de septiembre** (desde las 20 h) se arma según quién responde. Fundadores, dirigentes, emprendedores establecidos: gente que ya carga una responsabilidad real. No publicamos la lista de nombres de antemano; el filtro es el perfil y la intención.",
      "",
      "Es un **Save the Date**. Indicas tu interés, calibramos el lugar en el centro con el número de respuestas, y luego confirmamos. Según tu respuesta, recibirás una invitación formal con los detalles y las modalidades de pago por transferencia antes del encuentro.",
      "",
      "**Invitación nominativa.** Responde antes del **domingo 6 de septiembre**.",
      "",
      "Responder aquí:",
      EVENT_URL_ES,
      "",
  ...
  en: {
    ...
    body: [
      ...
      "",
      "The evening of **24 September** (from 8 pm) is shaped by who replies. Founders, directors, established entrepreneurs: people already carrying real responsibility. We do not publish the guest list in advance; the filter is profile and intent.",
      "",
      "This is a **Save the Date**. You share your interest, we size the downtown venue to the replies, then we confirm. Based on your reply, you will get a formal invitation with details and payment instructions by bank transfer before the dinner.",
      "",
      "**Nominative invite.** Please reply by **Sunday 6 September**.",
      "",
      "Reply here:",
      EVENT_URL_EN,
      "",
